...
var particleCount = 40,
  ...
  pMaterial = new THREE.PointsMaterial({
    size: 10,
    map: new THREE.TextureLoader().load("threejs/assets/particle-white.png"),
...
var bloomPass = new THREE.UnrealBloomPass(
  new THREE.Vector2(threeCanvas.offsetWidth, threeCanvas.offsetHeight),
  1.5,
  0.4,
  0.85
);
...
loader.load("threejs/assets/Quicksand Light_Regular.json", function (font) {
